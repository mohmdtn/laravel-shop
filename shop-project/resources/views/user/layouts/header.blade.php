        ...
        <section class="container-xxl ">
            <section class="d-md-flex justify-content-md-between align-items-md-center py-3">
                ...
                <section class="d-flex justify-content-between align-items-center d-md-block">
                    <a class="text-decoration-none" href="{{ route("user.home") }}"><img src="{{ asset("user-assets/images/logo/8.png") }}" alt="logo"></a>
                ...
                <section class="mt-3 mt-md-auto search-wrapper">
                    <section class="search-box">
                        <section class="search-textbox">
                            ...
                            <form action="{{ route("user.products") }}" method="get" class="w-100">
                                <input id="search" type="text" class="w-100" name="search" placeholder="جستجو ..." autocomplete="off" value="{{ request()->search }}">
                            </form>
                        </section>
                        <section class="search-result visually-hidden">
                            <section class="search-result-title">نتایج جستجو برای  <span class="search-words">"<span class="input-value"></span>"</span><span class="search-result-type">در دسته بندی ها</span></section>
                            <section class="data-category"></section>
                            <section class="search-result-title">نتایج جستجو برای  <span class="search-words">"<span class="input-value"></span>"</span><span class="search-result-type">در برندها</span></section>
                            <section class="data-brand"></section>
                            <section class="search-result-title">نتایج جستجو برای  <span class="search-words">"<span class="input-value"></span>"</span><span class="search-result-type">در کالاها</span></section>
                            <section class="data-product"></section>
                        </section>
                    </section>
                </section>
                    ...
                    @auth
                        <section class="d-inline px-3">
                            ...
                            <section class="dropdown-menu dropdown-menu-end custom-drop-down" aria-labelledby="dropdownMenuButton1">
                                <section><a class="dropdown-item" href="{{ route("user.profile.profile") }}"><i class="fa fa-user-circle"></i>پروفایل کاربری</a></section>
                                <section><a class="dropdown-item" href="{{ route("user.profile.orders") }}"><i class="fa fa-newspaper"></i>سفارشات</a></section>
                                <section><a class="dropdown-item" href="{{ route("user.profile.favorites") }}"><i class="fa fa-heart"></i>لیست علاقه مندی</a></section>
                                <section><hr class="dropdown-divider"></section>
                                <section><a class="dropdown-item" href="{{ route("auth.user.logout") }}"><i class="fa fa-sign-out-alt"></i>خروج</a></section>
            ...
            <nav class="">
                ...
                <section class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="z-index: 9999999;">
                    <section class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasExampleLabel"><a class="text-decoration-none" href="index.html"><img src="{{ asset("user-assets/images/logo/8.png") }}" alt="logo"></a></h5>
