...
<footer class="footer">
    <section class="container-xxl my-4">
            ...
            <section class="col">
                <section class="footer-shop-features d-md-flex justify-content-md-around align-items-md-center">
                    ...
                    <section class="footer-shop-features-item">
                        <img src="{{ asset("user-assets/images/footer/1.png") }}" alt="">
                        <section class="text-center">امکان تحویل اکسپرس</section>
                    </section>

                    <section class="footer-shop-features-item">
                        <img src="{{ asset("user-assets/images/footer/2.png") }}" alt="">
                        <section class="text-center">امکان پرداخت در محل</section>
                    </section>

                    <section class="footer-shop-features-item">
                        <img src="{{ asset("user-assets/images/footer/3.png") }}" alt="">
                        <section class="text-center">7 روز هفته، 24 ساعته</section>
                    </section>

                    <section class="footer-shop-features-item">
                        <img src="{{ asset("user-assets/images/footer/4.png") }}" alt="">
                        <section class="text-center">7 روز ضمانت بازگشت کالا</section>
                    </section>

                    <section class="footer-shop-features-item">
                        <img src="{{ asset("user-assets/images/footer/5.png") }}" alt="">
        ...
        <section class="row">
            ...
            <section class="col-md-5">
                <section>
                    ...
                    <section class="my-3">
                        <a href="{{ $settings->instagram }}" class="text-muted text-decoration-none me-5"><i class="fab fa-instagram"></i></a>
                        <a href="{{ $settings->telegram }}" class="text-muted text-decoration-none me-5"><i class="fab fa-telegram"></i></a>
                        <a href="{{ $settings->whatsapp }}" class="text-muted text-decoration-none me-5"><i class="fab fa-whatsapp"></i></a>
                        <a href="mailto:{{ $settings->email }}" class="text-muted text-decoration-none me-5"><i class="fa fa-envelope"></i></a>
                    </section>
                </section>
            </section>
        </section>
        <section class="row my-5">
            <section class="col">
                <section class="fw-bold">شرکت {{ $settings->title }}</section>
                <section class="text-muted footer-intro">ما همواره تلاش می کنیم بهترین خدمات را به مشتریان ارائه کنیم. به شما کمک می کنیم بهترین انتخاب را داشته باشید و با اطمینان خاطر خرید را انجام بدهید و در کوتاه ترین زمان ممکن کالای خود را دریافت کنید. همچنین ما 24 ساعته در هفت روز هفته به مشتریان مان خدمات ارائه می دهیم. و 7 روز ضمانت برگشت برای تمامی کالاها داریم.</section>
            </section>
        </section>
