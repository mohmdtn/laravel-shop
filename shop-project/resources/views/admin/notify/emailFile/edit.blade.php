...
@section("content")
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">ویرایش فایل اطلاعیه ایمیلی</li>
        </ol>
    </nav>
    ...
    <section class="pagesContent py-3 px-2">
        <div class="sectionHeader d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route("admin.notify.emailFile.index", $file["email"]["id"]) }}" class="btn btn-info btn-sm border-radius-4 box-shadow-normal">بازگشت</a>
        </div>
        ...
        <section class="pageContentInner">
            <form action="{{ route("admin.notify.emailFile.update", $file["id"]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method("put")
                <div class="row">
