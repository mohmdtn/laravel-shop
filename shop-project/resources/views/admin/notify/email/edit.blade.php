            ...
            <form action="{{ route("admin.notify.email.update", $email["id"]) }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control border-radius-5" name="subject" value="{{ old("subject", $email["subject"]) }}">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="hidden" class="form-control border-radius-5" id="published_at" name="published_at" value="{{ $email["published_at"] }}">
                        <input type="text" class="form-control border-radius-5" id="published_at_view" value="{{ $email["published_at"] }}">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control border-radius-5" name="body" id="body" rows="3">{{ old("body", $email["body"]) }}</textarea>
