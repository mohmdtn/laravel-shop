...
@section("head-tag")
    <title>ویرایش اولویت تیکت ها</title>
@endsection
...
@section("content")
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route("admin.ticket.priority.index") }}">اولویت تیکت ها</a></li>
            <li class="breadcrumb-item active" aria-current="page">ویرایش اولویت تیکت ها</li>
        </ol>
    </nav>
    ...
    <section class="pagesContent py-3 px-2">
        <div class="sectionHeader d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route("admin.ticket.priority.index") }}" class="btn btn-info btn-sm border-radius-4 box-shadow-normal">بازگشت</a>
        </div>
            ...
            <form action="{{ route("admin.ticket.priority.update", $ticketPriority["id"]) }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control border-radius-5" name="name" value="{{ old("name", $ticketPriority["name"]) }}">
