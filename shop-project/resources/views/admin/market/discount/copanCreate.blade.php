            ...
            <form action="{{ route("admin.market.discount.copan.store") }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control border-radius-5" name="code" value="{{ old("code") }}">
                        @error("code")
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control border-radius-5" name="amount" value="{{ old("amount") }}">
                        @error("amount")
                        <div class="errors"><span class="text-danger">{{ $message }}</span></div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="" class="form-control border-radius-5" name="amount_type" value="{{ old("amount_type") }}">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="" class="form-control border-radius-5" name="type" value="{{ old("type") }}">
                        ...
                        <div class="privateUserWrapper pt-3">
                            <label for="">انتخاب کاربر</label>
                            <select id="selectUser" class="form-control border-radius-5" name="user_id" value="{{ old("user_id") }}">
