            ...
            <form action="{{ route("admin.market.product.store") }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control border-radius-5" name="price" value="{{ old("price") }}">
                    ...
                    <div class="form-group col-md-4">
                        <label for="">وزن</label>
                        <input type="text" class="form-control border-radius-5" name="weight" value="{{ old("weight") }}">
                    ...
                    <div class="form-group col-md-4">
                        <label for="">طول</label>
                        <input type="text" class="form-control border-radius-5" name="length" value="{{ old("length") }}">
                    ...
                    <div class="form-group col-md-4">
                        <label for="">عرض</label>
                        <input type="text" class="form-control border-radius-5" name="width" value="{{ old("width") }}">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control border-radius-5" name="height" value="{{ old("height") }}">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="" class="form-control border-radius-5" name="brand_id">
                            ...
                            @foreach($brands as $brand)
                                <option value="{{ $brand["id"] }}" @if(old("brand_id") == $brand["id"]) selected @endif>{{ $brand["persian_name"] . " - " . $brand["original_name"] }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control border-radius-5" name="introduction" id="body" rows="3">{{ old("introduction") }}</textarea>
