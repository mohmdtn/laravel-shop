...
@section("content")
    ...
    <section class="pagesContent py-3 px-2">
        <div class="sectionHeader d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route("admin.content.category.index") }}" class="btn btn-info btn-sm border-radius-4 box-shadow-normal">بازگشت</a>
        </div>
            ...
            <form action="{{ route("admin.content.category.update" , $postCategory["id"]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control border-radius-5" name="name" value="{{ old('name' , $postCategory["name"]) }}">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="hidden" class="form-control border-radius-5" name="tags" id="tags" value="{{ old('tags' , $postCategory["tags"]) }}">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <textarea name="description" id="" class="form-control border-radius-5" rows="3">{{ old('description' , $postCategory["description"]) }}</textarea>
