...
@section("content")
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route("admin.content.faq.index") }}">سوالات متداول</a></li>
            ...
            <form action="{{ route("admin.content.faq.store") }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control border-radius-5" name="question" value="{{ old("question") }}">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control border-radius-5" name="answer" id="body" rows="3">{{ old("answer") }}</textarea>
