...
@section("content")
    ...
    <section class="pagesContent py-3 px-2">
        ...
        <section class="pageContentInner">
            <form action="{{ route("admin.content.page.update", $page["id"]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method("put")
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control border-radius-5" name="title" value="{{ old('title', $page["title"]) }}">
...
{{--                    </div>--}}
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="hidden" class="form-control border-radius-5" name="tags" id="tags" value="{{ old('tags', $page["tags"]) }}">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control border-radius-5" name="body" id="body" rows="3">{{ old('body', $page["body"]) }}</textarea>
